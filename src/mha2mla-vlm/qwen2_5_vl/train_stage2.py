...
from patching_qwenvl_stage2 import mha2mla_qwenvl_stage2_mutlimodal
...
# Import custom template hooks for Qwen2.5-VL multimodal processing
import qwenvl_template_hooks

# Register the custom hooks explicitly
...
class LlavaMLASFT(SwiftSft):
    ...
    def run(self):
        ...
        if self.mha2mla_args.peft_train is not None:
            freeze_non_attn_weights(
                self.model.model, self.mha2mla_args.peft_train
            )
