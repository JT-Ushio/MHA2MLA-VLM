...
STAGE1_CKPT_PATH="qwen2_5_vl/checkpoints/stage1_ckpt"
...
OUTPUT_PATH="qwen2_5_vl/analysis_svd/results/rope32_low_rank${LOW_RANK}.pt"
# =======================================

CUDA_VISIBLE_DEVICES=0 python src/mha2mla-vlm/qwen2_5_vl/run_svd_init.py \
