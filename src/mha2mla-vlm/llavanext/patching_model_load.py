...
from transformers import LlamaForCausalLM, Qwen2_5_VLForConditionalGeneration, Qwen2ForCausalLM
...
def patch_model_stage2_multimodal(model, model_args, mha2mla_args, if_train=True):
    ...
    for layer_idx, layer in enumerate(layers):
        ...
        if mha2mla_args.svd_init_weight_path and if_train:
            print("use svd_init_weight")
