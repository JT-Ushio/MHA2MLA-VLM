...
from transformers.models.llava_next.modeling_llava_next import LlavaNextCausalLMOutputWithPast, LlavaNextForConditionalGeneration
...
def forward_LlamaAttention_stage2_mutlimodal(
    ...
    **kwargs: Unpack[FlashAttentionKwargs],
    ...
    kv_shape = (*input_shape, self.config.num_key_value_heads, -1) # (bs, slen, num_key_value_heads, head_dim)
...
def forward_LlavaNextForConditionalGeneration_stage2_multimodal(
     self,
    input_ids: Optional[torch.LongTensor] = None,
...
def mha2mla_llama_stage2_mutlimodal(
    q_idx, k_idx
):
    ...
    LlavaNextForConditionalGeneration.forward = forward_LlavaNextForConditionalGeneration_stage2_multimodal
